...
namespace RCM.Application.ViewModels
{
    public class AplicacaoViewModel
    {
        ...
        [Display(Name = "Ano")]
        [Range(0, 2018, ErrorMessage = "O ano deve estar em um formáto válido")]
        public int Ano { get; set; }

        [Display(Name = "Marca")]
        [Required(AllowEmptyStrings = false, ErrorMessage = "O campo marca é requerido.")]
        [StringLength(100, MinimumLength = 4, ErrorMessage = "O campo marca deve ter entre 4 e 100 caracteres.")]
        public string Marca { get; set; }

        [Display(Name = "Modelo")]
        [Required(AllowEmptyStrings = false, ErrorMessage = "O campo modelo é requerido.")]
        [StringLength(250, MinimumLength = 5, ErrorMessage = "O campo modelo deve ter entre 5 e 250 caracteres.")]
